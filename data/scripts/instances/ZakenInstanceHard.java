...
public class ZakenInstanceHard extends Quest
{
	// NPCs
	private static int			DEVICE		= 1010015;
	private static int			EXIT_DEVICE	= 1010017;
	...
	private static int			levelReq		= Config.ZAKEN_HARD_LEVELS;
	private static int			pvpReq			= Config.ZAKEN_HARD_PVPS;
	private static int			healerPvpReq	= Config.ZAKEN_HARD_SUPPORT_PVPS;
	...
	public ZakenInstanceHard(int questId, String name, String descr)
	{
	...
	{
		new ZakenInstanceHard(-1, qn, "instances");
	}
	...
	public void spawnMobs(ZakenWorld world)
    {
        if (world.getStage() == 0)
        {
            addSpawn(1010051, 54225, 216829, -3742, 32361, false, 0, false, world.instanceId); // CAPTAIN
            addSpawn(1010050, 54336, 216796, -3747, 31654, false, 0, false, world.instanceId); // ZOMBIE
            addSpawn(1010050, 54316, 216871, -3733, 34377, false, 0, false, world.instanceId); // ZOMBIE
            addSpawn(1010050, 54279, 216916, -3728, 35111, false, 0, false, world.instanceId); // ZOMBIE
            world.liveMobs = 4;
        }
        if (world.getStage() == 1)
        {
            addSpawn(1010051, 55628, 216884, -3605, 29577, false, 0, false, world.instanceId); // CAPTAIN
            addSpawn(1010050, 55746, 216841, -3600, 33168, false, 0, false, world.instanceId); // ZOMBIE
            addSpawn(1010050, 55733, 216955, -3600, 35772, false, 0, false, world.instanceId); // ZOMBIE
            addSpawn(1010050, 55618, 216950, -3600, 33221, false, 0, false, world.instanceId); // ZOMBIE
            world.liveMobs = 4;
        }
        if (world.getStage() == 2)
        {
            addSpawn(1010052, 56340, 215861, -3487, 19083, false, 0, false, world.instanceId); // CAPTAIN
            world.liveMobs = 1;
        }
        if (world.getStage() == 3)
        {
            addSpawn(1010051, 52200, 217308, -3341, 51274, false, 0, false, world.instanceId); // CAPTAIN
            addSpawn(1010050, 52081, 217458, -3341, 49568, false, 0, false, world.instanceId); // ZOMBIE
            addSpawn(1010050, 52279, 217464, -3341, 48792, false, 0, false, world.instanceId); // ZOMBIE
            addSpawn(1010050, 52286, 217186, -3335, 49414, false, 0, false, world.instanceId); // ZOMBIE
            addSpawn(1010050, 52066, 217178, -3338, 50948, false, 0, false, world.instanceId); // ZOMBIE
            world.liveMobs = 5;
        }
        if (world.getStage() == 4)
        {
            addSpawn(1010051, 52221, 217248, -3342, 49409, false, 0, false, world.instanceId); // CAPTAIN
            addSpawn(1010050, 52764, 216906, -3333, 31552, false, 0, false, world.instanceId); // ZOMBIE
            addSpawn(1010050, 52754, 217278, -3333, 34302, false, 0, false, world.instanceId); // ZOMBIE
            addSpawn(1010050, 52745, 217580, -3344, 37783, false, 0, false, world.instanceId); // ZOMBIE
            addSpawn(1010050, 51716, 217597, -3342, 359, false, 0, false, world.instanceId); // ZOMBIE
            addSpawn(1010050, 51709, 217258, -3342, 3243, false, 0, false, world.instanceId); // ZOMBIE
            addSpawn(1010050, 51707, 216927, -3344, 61312, false, 0, false, world.instanceId); // ZOMBIE
            world.liveMobs = 7;
        }
        if (world.getStage() == 5)
        {
            addSpawn(1010053, 52207, 217319, -3341, 49644, false, 0, false, world.instanceId); // ZAKEN
            world.liveMobs = 1;
        }
        if (world.getStage() == 6)
        {
