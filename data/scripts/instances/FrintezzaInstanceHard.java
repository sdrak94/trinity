...
public class FrintezzaInstanceHard extends Quest
{
	// NPCs
	private static int			DEVICE		= 1010025;
	private static int			EXIT_DEVICE	= 1010028;
	...
	private static int			levelReq		= Config.FRINTEZZA_HARD_LEVELS;
	private static int			pvpReq			= Config.FRINTEZZA_HARD_PVPS;
	private static int			healerPvpReq	= Config.FRINTEZZA_HARD_SUPPORT_PVPS;
	...
	public FrintezzaInstanceHard(int questId, String name, String descr)
	{
	...
	{
		new FrintezzaInstanceHard(-1, qn, "instances");
	}
	...
	public void spawnMobs(L2PcInstance player, FrintezzaWorld world, Location loc)
    {
        ...
        {
            openGates(player, 1);
            addSpawn(1010060, 173192, -76907, -5111, 39884, false, 0, false, world.instanceId);
            addSpawn(1010060, 174107, -77277, -5104, 30603, false, 0, false, world.instanceId);
            addSpawn(1010060, 174927, -76981, -5108, 5141, false, 0, false, world.instanceId);
            addSpawn(1010060, 175354, -76101, -5108, 45693, false, 0, false, world.instanceId);
            addSpawn(1010060, 175021, -75125, -5111, 57865, false, 0, false, world.instanceId);
            addSpawn(1010060, 174112, -74778, -5111, 46398, false, 0, false, world.instanceId);
            addSpawn(1010060, 173263, -75195, -5104, 3968, false, 0, false, world.instanceId);
            addSpawn(1010060, 172884, -76002, -5104, 16383, false, 0, false, world.instanceId);
            world.liveMobs = 8;
        }
        if (world.getStage() == 2) // 2nd Room BOSS STAGE
        {
            openGates(player, 2);
            addSpawn(1010062, 174032, -81872, -5124, 16383, false, 0, false, world.instanceId);
            world.liveMobs = 1;
        }
        if (world.getStage() == 3) // 2nd Room Mobs Stage 1
        {
            openGates(player, 3);
            addSpawn(1010061, 175320, -81762, -5108, 32864, false, 0, false, world.instanceId); 
            addSpawn(1010061, 175367, -82324, -5108, 28440, false, 0, false, world.instanceId);
            addSpawn(1010061, 175311, -81220, -5108, 40689, false, 0, false, world.instanceId);
            addSpawn(1010061, 172795, -81817, -5111, 935, false, 0, false, world.instanceId); 
            addSpawn(1010061, 172739, -81258, -5108, 59709, false, 0, false, world.instanceId);
            addSpawn(1010061, 172739, -82332, -5108, 5324, false, 0, false, world.instanceId);
            world.liveMobs = 6;
        }
        if (world.getStage() == 4) // Mini Boss Spawn
        {
            openGates(player, 4);
            addSpawn(1010063, 174233, -88004, -5115, 15949, false, 0, false, world.instanceId);
            world.liveMobs = 1;
        }
        if (world.getStage() == 5) // Grand Boss Spawn
        {
    		ThreadPoolManager.getInstance().scheduleGeneral(new Runnable()
    		{
				...
				{
					if (loc != null)
						addSpawn(1010064, loc.getX(), loc.getY(), loc.getZ(), 15344, false, 0, false, world.instanceId);
					else
						addSpawn(1000064, 174235, -88024, -5115, 16383, false, 0, false, world.instanceId);
