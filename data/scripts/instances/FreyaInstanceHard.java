...
public class FreyaInstanceHard extends Quest
{
	// NPCs
	private static int			DEVICE			= 1010035;
	private static int			EXIT_DEVICE		= 1010037;
	private static int[]		MOBS			=
	{
		1010030, 1010031, 1010032, 1010034
	};
	private static String		qn				= "FreyaInstanceHard";
	private static final int	INSTANCEID		= 5004;
	private static boolean		debug			= false;
	
	private static int			levelReq		= Config.FREYA_HARD_LEVELS;
	private static int			pvpReq			= Config.FREYA_HARD_PVPS;
	private static int			healerPvpReq	= Config.FREYA_HARD_SUPPORT_PVPS;
	...
	public FreyaInstanceHard(int questId, String name, String descr)
	{
	...
	{
		new FreyaInstanceHard(-1, qn, "instances");
	}
	...
	public void spawnMobs(FreyaWorld world)
	{
        ...
        if (world.getStage() == 1)
        {
            ...
            addSpawn(1010032, 115855, -114133, -11202, 36302, false, 0, false, world.instanceId); // KNIGHT
