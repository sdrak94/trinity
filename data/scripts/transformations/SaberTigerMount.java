 ...
 *
 */
public class SaberTigerMount extends L2Transformation
{
	public SaberTigerMount()
	{
		// id, duration (secs), colRadius, colHeight
		super(60003, 1800, 12.0, 20.0);
	}

	public void onTransform()
	{
		if (getPlayer().getTransformationId() != 60003 || getPlayer().isCursedWeaponEquipped())
			return;
