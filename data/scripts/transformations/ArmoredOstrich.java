 ...
 *
 */
public class ArmoredOstrich extends L2Transformation
{
	public ArmoredOstrich()
	{
		// id, duration (secs), colRadius, colHeight
		super(60029, 1800, 18.0, 33.0);
	}

	public void onTransform()
	{
		if (getPlayer().getTransformationId() != 60029 || getPlayer().isCursedWeaponEquipped())
			return;
