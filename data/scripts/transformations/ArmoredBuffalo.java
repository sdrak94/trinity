 ...
 *
 */
public class ArmoredBuffalo extends L2Transformation
{
	public ArmoredBuffalo()
	{
		// id, duration (secs), colRadius, colHeight
		super(60028, 1800, 18.0, 31.0);
	}

	public void onTransform()
	{
		if (getPlayer().getTransformationId() != 60028 || getPlayer().isCursedWeaponEquipped())
			return;
