 ...
 *
 */
public class ElderPegasusMount extends L2Transformation
{
	public ElderPegasusMount()
	{
		// id, duration (secs), colRadius, colHeight
		super(60017, 1800, 20.0, 24.0);
	}

	public void onTransform()
	{
		if (getPlayer().getTransformationId() != 60017 || getPlayer().isCursedWeaponEquipped())
			return;
