package scripts.instances.Tezza;
...
public class FrintezzaInstance extends Quest
{
	...
	{
		1000016,1010020,1010021,1010022,1010023,1010024
	};
	...
	public void spawnMobs(L2PcInstance player, FrintezzaWorld world, Location loc)
    {
        if (world.getStage() == 0)
        {
            addSpawn(1000016, 174076, -76041, -5108, 31233, false, 0, false, world.instanceId); // Alarm
            world.liveMobs = 1;
        }
        if (world.getStage() == 1)
        {
