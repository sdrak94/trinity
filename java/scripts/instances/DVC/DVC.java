...
public class DVC extends Quest {
    ...
    //BOSSES
    private static final int[] BOSSES = {95622, 95623, 95624, 95634};
    ...
    //MOBS
    private static final int[] MOBS = {95132, 95131, 95129};
        ...
        if (npcId == MALKION) {
        	...
        	if (party != null)
			{
				for (L2PcInstance ptm : party.getPartyMembers())
				{
					...
					if (ptm.getInstanceId()==0) continue;
