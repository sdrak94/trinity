 ...
 *
 */
public class LindviorMount extends L2Transformation
{
	public LindviorMount()
	{
		// id, duration (secs), colRadius, colHeight
		super(60004, 1800, 20.0, 34.5);
	}

	public void onTransform()
	{
		if (getPlayer().getTransformationId() != 60004 || getPlayer().isCursedWeaponEquipped())
			return;
