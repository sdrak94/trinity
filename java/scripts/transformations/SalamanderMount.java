 ...
 *
 */
public class SalamanderMount extends L2Transformation
{
	public SalamanderMount()
	{
		// id, duration (secs), colRadius, colHeight
		super(60001, 1800, 12.0, 26.0);
	}

	public void onTransform()
	{
		if (getPlayer().getTransformationId() != 60001 || getPlayer().isCursedWeaponEquipped())
			return;
