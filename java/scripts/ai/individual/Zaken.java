...
public class Zaken extends L2AttackableAIScript
{
    ...
    {	
        ...
        if (npcId == ZAKEN)
        {
        	...
        	((L2Attackable)npc).addDamageHate(originalAttacker,hate);
        	if (Rnd.get(10) < 1)
        	{
    ...
    public String onSkillSee (L2Npc npc, L2PcInstance caster, L2Skill skill, L2Object[] targets, boolean isPet)
    {
        ...
        if (npcId == ZAKEN)
        {
        	...
        	{
        		((L2Attackable)npc).addDamageHate(caster,(((skill.getAggroPoints() / npc.getMaxHp())*10)*150));
        	}
        	if (Rnd.get(12) < 1)
        	{
        		int i0 = Rnd.get(( 15 * 15 ));
    ...
    public String onAggroRangeEnter (L2Npc npc, L2PcInstance player, boolean isPet) 
    {
        ...
        if (npcId == ZAKEN)
        {
			if(_Zone.isInsideZone(npc))
			{
				...
				((L2Attackable)npc).addDamageHate(target,200);
			}
