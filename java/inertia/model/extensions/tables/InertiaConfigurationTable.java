package inertia.model.extensions.tables;
...
{
	final HashMap<String, InertiaConfiguration> inertiaTemplates = new HashMap<>();
	...
	private void load() throws Exception
	{
		...
		final File templatesFolder = new File("./data/xml/inertia/extensions/");
