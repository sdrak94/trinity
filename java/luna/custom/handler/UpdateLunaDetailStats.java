...
public final class UpdateLunaDetailStats extends L2GameServerPacket
{
	private static final String _S__1B_UPDATELUNADETAILEDSTATS = "[S] 19 UpdateLunaDetailedStats";
	private final String _html;
	
	public UpdateLunaDetailStats(String html, L2PcInstance activeChar)
	{
		...
		_html = "=:LunaAdvancedStatsUpdateWnd:= "+ content;
//		_html = "=:LunaAutoPots:= "+ content;
	...
	{
		return _S__1B_UPDATELUNADETAILEDSTATS;
	}
}
