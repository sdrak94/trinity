 ...
 */
public class CopyOfL2Npc extends L2Character
{
...
public void loadDropHTML()
{
	...
	else
	{
	  ...
	  npcinfo.append("					<img src=\"L2UI.SquareBlank\" width=300 height=3>")
		     .append("					<img src=\"L2UI.SquareGray\" width=300 height=2>")
		     .append("					<img src=\"L2UI.SquareBlank\" width=300 height=3>")
		     .append("					<table width=300 bgcolor=2E2E2E>")
		     ...
		     .append("					<font color=86AA6F> " + String.valueOf((getElite() > 0)) +  "</font>")
		     .append("					</td><td width=30px><font color=696969>Rare:</font></td><td>")
		     .append("					<font color=86AA6F> " + String.valueOf((getRare() > 0)) +  "</font>")
		     .append("					</td></tr>")
		     .append("					<tr><td width=30px><font color=696969>Random X:</font></td><td>")
		     .append("					<font color=86AA6F>" + String.valueOf(spawn != null ? spawn.getSpawnType() == 1 ? "at a random pc" : spawn.getRandomX() : "N/A") +"</font>")
		     .append("					</td><td width=30px><font color=696969>Random Y:</font></td><td>")
		     .append("					<font color=86AA6F>" + String.valueOf(spawn != null ? spawn.getSpawnType() == 1 ? "at a random pc" : spawn.getRandomY() : "N/A") +"</font>")
		     .append("					</td></tr>")
		     .append("					<tr><td width=30px><font color=696969>Spawn Time:</font></td><td>")
		     .append("					<font color=86AA6F>" + String.valueOf(time == 2 ? "Night" : time == 1 ? "Day" : "Always") + "</font>")
		     .append("					</td>")
		     .append("					<td width=30px><font color=696969>Respawn:</font></td><td>")
		     .append("					<font color=86AA6F>"+ respawntime + "</font>")
		     .append("					</td></tr>")
		     .append("					<tr><td width=30><font color=696969>Faction</font></td><td width=50>")
		     .append("					<font color=86AA6F>" + getFactionIdString() + "</font>")
		     .append("					</td><td width=30><font color=696969>AggroRange</font></td><td width=50>")
		     .append("					<font color=86AA6F>" + formatString(getAggroRange()) + "</font>")
		     .append("					</td></tr>")
		     .append("					<tr><td width=30><font color=696969>FactionRange</font></td><td width=50>")
		     .append("					<font color=86AA6F>" + formatString(getFactionRange()) + "</font>")
		     .append("					</td></tr>")
		     .append("					</table>")
		     .append("					<img src=\"L2UI.SquareBlank\" width=300 height=3>")
		     .append("					<img src=\"L2UI.SquareGray\" width=300 height=2>")
	...
	{
	  npcinfo.append("					<img src=\"L2UI.SquareGray\" width=300 height=2>")
		     .append("					<img src=\"L2UI.SquareBlank\" width=300 height=3>")
		     .append("					<table width=300 bgcolor=2E2E2E>")
		     ...
		     .append("					<font color=\"3239ff\">3%+</font> <font color=\"ff5194\">1%+</font> <font color=\"ff3310\">1%-</font></td></tr>")
		     .append("					</table>")
		     .append("					<img src=\"L2UI.SquareBlank\" width=300 height=3>")
		     .append("					<img src=\"L2UI.SquareGray\" width=300 height=2>")
		     .append("					<img src=\"L2UI.SquareBlank\" width=300 height=3>")
 ...
 *
 */
public CopyOfL2Npc(int objectId, L2NpcTemplate template)
{
