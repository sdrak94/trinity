...
public class NewRussianRullete
{
	protected static final Logger			_log				= Logger.getLogger(NewRussianRullete.class.getName());
	...
	public static L2Npc						_eventor			= null;
	...
	public static boolean teleportStart()
	{
		...
		ThreadPoolManager.getInstance().scheduleGeneral(new Runnable()
		{
			...
			{
				// sit();
				for (L2PcInstance player : NewRussianRullete._players)
				{
					if (player != null)
					{
