...
public final class QuestState
{
	...
	public void addNotifyOfDeath(L2Character character)
	{
		...
		character.getActingPlayer().addNotifyQuestOfDeath(this);
	}
	...
	public QuestState exitQuest(boolean repeatable)
	{
		...
		if (Config.L2JMOD_ACHIEVEMENT_SYSTEM && (getQuest().getQuestIntId() > 0))
		{
			if (repeatable)
			{
				_player.getCounters().repeatableQuestsCompleted++;
			}
			else
			{
				_player.getCounters().unrepeatableQuestsCompleted++;
			}
		}
