...
public class Auction
{
	...
	/** Return Item in WHC */
	private void returnItem(String Clan, int itemId, long quantity, boolean penalty)
	{
		if (penalty)
	...
	/** Take Item in WHC */
	private boolean takeItem(L2PcInstance bidder, int itemId, long requiredAdena)
	{
		if (bidder.getClan() != null && bidder.getClan().getWarehouse().getAdena() >= requiredAdena)
		{
			bidder.getClan().getWarehouse().destroyItemByItemId("Buy", _adenaId, requiredAdena, bidder, bidder);
			return true;
		}
