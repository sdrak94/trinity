 ...
 * <h1>How to Use It</h1>
 * <h2>concat() or append()</h2> If concatenating strings
 ...
 * 
 * Why?</br>
 * In first case, new memory has to be allocated for the second
 ...
 * works as in the first case.
 * <h2>Primitives to Strings</h2> To convert
 * primitives to string, use String.valueOf().
...
public final class StringUtil
{
	...
	public static String getNumberOrdinalSuffix(int i)
	{
		int j = i % 10;
		int k = i % 100;
		if (j == 1 && k != 11)
