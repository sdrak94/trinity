...
public final class Formulas
{
	...
	public static final double calcPhysDam(L2Character attacker, L2Character target, L2Skill skill, byte shld, boolean crit, boolean dual, boolean ss)
	{
		...
		else if (target instanceof L2PcInstance)
		{
			...
			{
				String ActiveClass = attacker.getActingPlayer().getClassId().getName();
				switch (ActiveClass)
				{
					case "Duelist":
						damage *= Config.CLASS_BALANCE_DUELIST;
						break;
					case "Dreadnought":
						damage *= Config.CLASS_BALANCE_DREADNOUGHT;
						break;
					case "Phoenix Knight":
						damage *= Config.CLASS_BALANCE_PHOENIX_KNIGHT;
						break;
					case "Hell Knight":
						damage *= Config.CLASS_BALANCE_HELL_KNIGHT;
						break;
					case "Sagittarius":
						damage *= Config.CLASS_BALANCE_SAGITTARIUS;
						break;
					case "Adventurer":
						damage *= Config.CLASS_BALANCE_ADVENTURER;
						break;
					case "Hierophant":
						damage *= Config.CLASS_BALANCE_HIEROPHANT;
						break;
					case "Eva Templar":
						damage *= Config.CLASS_BALANCE_EVA_TEMPLAR;
						break;
					case "Sword Muse":
						damage *= Config.CLASS_BALANCE_SWORD_MUSE;
						break;
					case "Wind Rider":
						damage *= Config.CLASS_BALANCE_WIND_RIDER;
						break;
					case "Moonlight Sentinel":
						damage *= Config.CLASS_BALANCE_MOONLIGHT_SENTINEL;
						break;
					case "Shillien Templar":
						damage *= Config.CLASS_BALANCE_SHILLIEN_TEMPLAR;
						break;
					case "Spectral Dancer":
						damage *= Config.CLASS_BALANCE_SPECTRAL_DANCER;
						break;
					case "Ghost Hunter":
						damage *= Config.CLASS_BALANCE_GHOST_HUNTER;
						break;
					case "Ghost Sentinel":
						damage *= Config.CLASS_BALANCE_GHOST_SENTINEL;
						break;
					case "Titan":
						damage *= Config.CLASS_BALANCE_TITAN;
						break;
					case "Grand Khauatari":
						damage *= Config.CLASS_BALANCE_GRAND_KHAUATARI;
						break;
					case "Fortune Seeker":
						damage *= Config.CLASS_BALANCE_FORTUNE_SEEKER;
						break;
					case "Maestro":
						damage *= Config.CLASS_BALANCE_MAESTRO;
						break;
					case "Doombringer":
						damage *= Config.CLASS_BALANCE_DOOMBRINGER;
						break;
					case "Male Soulhound":
						damage *= Config.CLASS_BALANCE_MALE_SOULHOUND;
						break;
					case "Female Soulhound":
						damage *= Config.CLASS_BALANCE_FEMALE_SOULHOUND;
						break;
					case "Trickster":
						damage *= Config.CLASS_BALANCE_TRICKSTER;
						break;
					case "Inspector":
						damage *= Config.CLASS_BALANCE_INSPECTOR;
						break;
					case "Judicator":
						damage *= Config.CLASS_BALANCE_JUDICATOR;
						break;
				}
			}
			...
			{
				/*
				 * if (attacker instanceof L2RaidBossInstance && target.getActingPlayer().isTankClass())
				 * damage += 500;
				 */
	...
	public static final double calcMagicDam(L2Character attacker, L2Character target, L2Skill skill, byte shld, boolean ss, boolean bss, boolean mcrit)
	{
		...
		if (target instanceof L2PcInstance)
		{
			...
			if ((attacker instanceof L2Playable))
			{
				...
				{
					case "Archmage":
						damage *= Config.CLASS_BALANCE_ARCHMAGE;
						break;
					case "Soultaker":
						damage *= Config.CLASS_BALANCE_SOULTAKER;
						break;
					case "Arcana Lord":
						damage *= Config.CLASS_BALANCE_ARCANA_LORD;
						break;
					case "Cardinal":
						damage *= Config.CLASS_BALANCE_CARDINAL;
						break;
					case "Hierophant":
						damage *= Config.CLASS_BALANCE_HIEROPHANT;
						break;
					case "Mystic Muse":
						damage *= Config.CLASS_BALANCE_MYSTIC_MUSE;
						break;
					case "Elemental Master":
						damage *= Config.CLASS_BALANCE_ELEMENTAL_MASTER;
						break;
					case "Eva Saint":
						damage *= Config.CLASS_BALANCE_EVA_SAINT;
						break;
					case "Storm Screamer":
						damage *= Config.CLASS_BALANCE_STORM_SCREAMER;
						break;
					case "Spectral Master":
						damage *= Config.CLASS_BALANCE_SPECTRAL_MASTER;
						break;
					case "Shillien Saint":
						damage *= Config.CLASS_BALANCE_SHILLIEN_SAINT;
						break;
					case "Dominator":
						damage *= Config.CLASS_BALANCE_DOMINATOR;
						break;
					case "Doomcryer":
						damage *= Config.CLASS_BALANCE_DOOMCRYER;
						break;
					case "Male Soulhound":
						damage *= Config.CLASS_BALANCE_MALE_SOULHOUND;
						break;
