...
public class L2Henna
{
	...
	public L2Henna(StatsSet set)
	{
		...
		if (statINT > 0) name += "INT +"+statINT;
		if (statSTR > 0) name += "STR +"+statSTR;
		if (statCON > 0) name += "CON +"+statCON;
		if (statMEM > 0) name += "MEN +"+statMEM;
		if (statDEX > 0) name += "DEX +"+statDEX;
		if (statWIT > 0) name += "WIT +"+statWIT;
