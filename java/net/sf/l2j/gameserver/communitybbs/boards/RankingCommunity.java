...
{/*
	...
	{
		String html = HtmCache.getInstance().getNotNull("data/html/CommunityBoard/" + "off.htm", player);
		...
		if(bypass.equals("_bbsloc") || bypass.equals("_bbsranking:pk"))
			...
			show(player, 5);
		else if(bypass.equals("_bbsranking:adena") && player.getAccessLevel().getLevel() > 0);
			show(player, 6);
	}
	...
	private void show(L2PcInstance player, int page)
	{
		...
		if(page == 1)
		{
			html = HtmCache.getInstance().getNotNull("data/html/CommunityBoard/" + "ranking/pk.htm", player);
			while(number < 10)
			{
		...
		{
			html = HtmCache.getInstance().getNotNull("data/html/CommunityBoard/" + "ranking/pvp.htm", player);
			while(number < 10)
			{
		...
		{
			html = HtmCache.getInstance().getNotNull("data/html/CommunityBoard/" + "ranking/rk.htm", player);
			while(number < 10)
			{
		...
		{
			html = HtmCache.getInstance().getNotNull("data/html/CommunityBoard/" + "ranking/cis.htm", player);
			while(number < 10)
			{
		...
		{
			html = HtmCache.getInstance().getNotNull("data/html/CommunityBoard/" + "ranking/cip.htm", player);
			while(number < 10)
			{
		...
		{
			html = HtmCache.getInstance().getNotNull("data/html/CommunityBoard/" + "ranking/adena.htm", player);
			while(number < 10)
			{
		...
		html = html.replace("<?ranking_menu?>", HtmCache.getInstance().getNotNull("data/html/CommunityBoard/" + "ranking/menu.htm", player));
		ShowBoard.separateAndSend(html, player);
	}
