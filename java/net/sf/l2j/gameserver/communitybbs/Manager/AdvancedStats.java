...
private static void appendPlayer(final StringBuilder sb, final int pos, TopData topData)
{
	...
	//sb.append("<td width=55 align=center valign=top><font color="+poscolor+">"+topData.getPkKills()+"</font></td>");
	//sb.append("<td width=55 align=center valign=top><font color="+poscolor+">"+topData.getFame()+"</font></td>");
	//sb.append("<td width=55 align=center valign=top><font color="+poscolor+">"+topData.getRaidPoints()+"</font></td>");
	sb.append("</tr>");
	/*
	sb.append("<tr>");
	sb.append("<td width=760 align=center>");
	sb.append("<table width=760 height=25 bgcolor=212121>");
	sb.append("<tr>");
	sb.append("<td align=center>");
	sb.append("<table>");
	sb.append("<tr>");
	sb.append("<td width=18 align=center valign=top><font name=__SYSTEMWORLDFONT color=b09979>"+(pos + 1)+"</font></td>"+posicon+"");
	
	if (player != null)
		sb.append("<td width=160 align=center valign=top><font color="+poscolor+">"+"<a action=\"bypass _bbsloc;playerinfo;" +topData.getCharName() + "\">"+topData.getCharName()+"</a>"+"</font></td>");
	else
		sb.append("<td width=160 align=center valign=top><font color="+poscolor+">"+topData.getCharName()+"</font></td>");
	sb.append("<td width=160 align=center valign=top>");
	sb.append("<font color="+poscolor+">"+ charTitle +"</font>");
	sb.append("</td>");
	sb.append("<td width=160 align=center valign=top>");
	sb.append("<font color="+poscolor+">"+topData.getClanName()+"</font>");
	sb.append("</td>");
	sb.append("<td width=160 align=center valign=top>");
	sb.append("<font color="+poscolor+">"+topData.getClassName()+"</font>");
	sb.append("</td>");
	sb.append("<td width=55 align=center valign=top>");
	sb.append("<font color="+poscolor+">"+topData.getPvpKills()+"</font>");
	sb.append("</td>");
	sb.append("<td width=55 align=center valign=top>");
	sb.append("<font color="+poscolor+">"+topData.getPkKills()+"</font>");
	sb.append("</td>");
	sb.append("<td width=55 align=center valign=top>");
	sb.append("<font color="+poscolor+">"+topData.getFame()+"</font>");
	sb.append("</td>");
	sb.append("<td width=55 align=center valign=top>");
	sb.append("<font color="+poscolor+">"+topData.getRaidPoints()+"</font>");
	sb.append("</td>");
	sb.append("</tr>");
	sb.append("</table>");
	sb.append("</td>");
	...
	sb.append("</td>");
	sb.append("</tr>");*/
	//sb.append("<img src=L2UI_CT1_CN.Windows.TitleBG width=760 height=1>");
...
private static class SingletonHolder
{
	...
	@Override
	public void parsewrite(String bypass, String ar1, String ar2, String ar3, String ar4, String ar5,
