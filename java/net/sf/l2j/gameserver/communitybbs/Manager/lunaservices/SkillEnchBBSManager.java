...
public class SkillEnchBBSManager 
{
	public static SkillEnchBBSManager getInstance()
	{
	...
	{
			String path = "data/html/CommunityBoard/skillench/";
			String filepath = "";
			String content = "";
			if (command.equals("_bbsskillench"))
			 		{

				filepath = path +"skill_enchant.htm";
				content = HtmCache.getInstance().getHtm(activeChar.getHtmlPrefix(), filepath);
				separateAndSend(content, activeChar);
			 		}

			else if (command.equalsIgnoreCase("trainskill"))
			{
	...
	{
	protected static final SkillEnchBBSManager _instance = new SkillEnchBBSManager();
	}
}
