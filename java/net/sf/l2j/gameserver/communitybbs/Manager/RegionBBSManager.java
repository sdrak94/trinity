...
private void showOldCommunityPI(L2PcInstance activeChar, String name)
{
	...
	if (player != null)
	{
		...
		if (activeChar != null && (activeChar.isGM() || player.getObjectId() == activeChar.getObjectId() || Config.SHOW_LEVEL_COMMUNITYBOARD))
		{
			...
			//StringUtil.append(htmlCode, "<br><center><table><tr><td><multiedit var=\"pm\" width=400 height=30><button value=\"Send PM\" action=\"Write Region PM ", player.getName(), " pm pm pm\" width=110 height=15 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\"></td><td><button value=\"Back\" action=\"bypass _bbsloc\" width=40 height=15 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\"></td></tr>"	+ "</table></center><br>");
		}
...
private void writeCommunityPages()
{
	...
	for (int page : _onlinePlayers.keySet())
	{
		...
		StringUtil.append(htmlCode, 				"<html>\r\n" + 
				...
				"			<table border=0 cellpadding=0 cellspacing=0 width=769 height=50 background=\"l2ui_ct1.Windows_DF_TooltipBG\">"+
				"				<tr>"+
				"					<td valign=\"top\" align=\"center\" valign=top>"+
				"						<table width=755 height=50>"+
				"							<tr>"+
				"								<td width=755><br>"+
				"									<table border=0 cellspacing=0 cellpadding=0 width=755 height=20>"+
				"										<tr>"+
				"											<td WIDTH=375 align=center valign=top>"+
				"												<font name=hs12 color=AFACEC>Region</font><br>"+
				"											</td>"+
				"										</tr>"+
				"									</table>"+
				"									<table width=760 cellspacing=0 cellpadding=0 height=50 border=0>"+
				"										<tr>"+
				"											<td align=center>"+
				"												<table width=740 border=0>"+
				"													<tr>"+
				"														<td width=740 align=center>"+
				"															<table cellspacing=3 cellpadding=4 width=740 height=40 bgcolor=373737>"+
				"																<tr>"+
				"																	<td FIXWIDTH=40 align=right valign=top>"+
				"																		<table border=0 cellspacing=0 cellpadding=0 width=32 height=32 background=\"icon.skill0817\">"+
				"																			<tr>"+
				"																				<td width=32 align=center valign=top>"+
				"																					<img src=\"L2UI_CH3.BloodHoodWnd.bloodhood_icon04\" width=\"36\" height=\"36\">"+
				"																				</td>"+
				"																			</tr>"+
				"																		</table>"+
				"																	</td>"+
				"																	<td FIXWIDTH=500 align=center valign=top>"+
				"																		<br1> <font name=__SYSTEMWORLDFONT>Server Restarted: "+ String.valueOf(GameServer.dateTimeServerStarted.getTime())+ "</font>"
																					 + "<br1> <font name=__SYSTEMWORLDFONT>Online Players: "+ String.valueOf(L2World.getInstance().getAllPlayersCount())+ " Player(s) online in L2 Trinity.</font></td>"+
				"<td FIXWIDTH=40 align=right valign=top>"+
				"<table border=0 cellspacing=0 cellpadding=0 width=36 height=32 background=\"icon.skill0817\">"+
				"																			<tr>"+
				"																				<td width=32 align=center valign=top>"+
				"																					<img src=\"L2UI_CH3.BloodHoodWnd.bloodhood_icon04\" width=\"36\" height=\"36\">"+
				"																				</td>"+
