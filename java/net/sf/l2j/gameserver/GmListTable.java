...
public class GmListTable
{
	...
	public static void broadcastMessageToAdvancedGMs2(String message)
	{
		for (L2PcInstance gm : getInstance().getAllGms(true))
		{
			//if (gm.getName().equalsIgnoreCase("[GM]Brado") || gm.getName().equalsIgnoreCase("[GM]Fate") || gm.getName().equalsIgnoreCase("[GM]Alfie"))
				gm.sendMessage(message);
		}
	}
